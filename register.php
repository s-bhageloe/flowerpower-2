...
include_once 'database.php'; 
    ...
    if (isset($_POST['submit'])){
        ...
        /*If there is not a error, data will be inserted in the database */
            ...
            $obj->create_klant($_POST['voorletters'],
...
<body>
  <div class="registerStyle">
    <form method="POST" class="loginForm">       
      ...
      <input type="text" class="formRegister" name="tussenvoegsels" placeholder="Tussenvoegsel" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" /><br><br>
      ...
      <input type="date" class="formRegister" name="geboortedatum" placeholder="Geboortedatum" required/><br><br>
